        ...
        <Dialog.Title className='text-3xl font-black'> Publique um Anúncio! </Dialog.Title>
          ...
          <form onSubmit={handleSubmit} className='mt-8 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <InputForm name='name' id='name' placeholder='Como te chamam dentro do game?'/>
            </div>
            
            <div className='grid grid-cols-2 gap-6'>
              <div className='flex flex-col gap-2'>
                <label htmlFor="yearsPlayng">Joga há quantos anos?</label>
                <InputForm  name='yearsPlayng' id='yearsPlayng' type="number" placeholder='Tudo bem ser ZERO'/>
              </div>
            ...
            <div className='flex gap-6'>
                ...
                <label htmlFor="weekDays">Quando costuma jogar?</label>
                  <ToggleGroup.Root 
                    ...
                    <ToggleGroup.Item  
                      value='1'
                      title='Segunda'
                      className={`w-8 h-8 rou1ded ${weekDays.includes('1') ? 'bg-violet-500' :'bg-zinc-900'}`}
                    >
                      S
                      </ToggleGroup.Item >
                    <ToggleGroup.Item  
                      value='2'
                      title='Terça'  
                      className={`w-8 h-8 rou2ded ${weekDays.includes('2') ? 'bg-violet-500' :'bg-zinc-900'}`}
                    >
                      T
                      </ToggleGroup.Item >
                    <ToggleGroup.Item  
              ...
              <div className='flex flex-col gap-2 flex-1'>
                  ...
                  <div className='grid grid-cols-2 gap-2'>
                    <InputForm name='hoursStart'id="hoursStart" type="time" placeholder='De'/>
                    <InputForm name='hoursEnd'id="hoursEnd" type="time" placeholder='Até'/>
                  </div>
              </div>
            </div>
